...
extern "C" {
	...
	OIIO::ImageSpec* COIIO_ImageSpec_new_2D(int xres, int yres, int nchans, const OIIO::TypeDesc* fmt);
	...
	void COIIO_ImageSpec_set_format(OIIO::ImageSpec* this_, const OIIO::TypeDesc* format);
	// TypeDesc
	...
	// ImageInput
	OIIO::ImageInput* COIIO_ImageInput_open(const char* filename, const OIIO::ImageSpec* config);
	...
	bool COIIO_ImageInput_read_image(OIIO::ImageInput* this_, const OIIO::TypeDesc* format, void* data);
